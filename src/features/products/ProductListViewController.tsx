...
export type SortField = 'id' | 'name' | 'price' | 'stock';
...
export default function ProductListViewController({ onSelectProduct, selectedProductId }: ProductListViewControllerProps) {
